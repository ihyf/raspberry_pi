...
from openerp.addons.hw_scanner.controllers.picking import start_the_machine,STATE
...
def start_scanner_server():
    start_the_machine(STATE, scanner_thread)
...
class ScannerDriver(hw_proxy.Proxy):
    ...
    @http.route('/start_server', type='json', auth='none', cors='*')
